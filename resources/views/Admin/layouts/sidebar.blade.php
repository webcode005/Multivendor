        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboards -->
            <li class="menu-item @if(Session::get('page')=='dashboard') active open @endif">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Vendor Details">Vendor Details</div>
              </a>

              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{ url('admin/update-vendor-details/personal')}}" class="menu-link">
                    <div data-i18n="Personal Details">Personal Details</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ url('admin/update-vendor-details/business')}}" class="menu-link">
                    <div data-i18n="Business Details">Business Details</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{ url('admin/update-vendor-details/bank')}}" class="menu-link">
            ...
            <li class="menu-item @if(Session::get('page')=='brands' || Session::get('page')=='categories'|| Session::get('page')=='subcategories' || Session::get('page')=='subcat' || Session::get('page')=='view_products') active open @endif">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
