              ...
              <div class="row">
                <div class="col-md-12">
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    ...
                    <li class="nav-item">
                      <a class="nav-link active" href="{{url('/admin/setting')}}"
                  ...
                  @endif
                      <form  autocomplete="off" id="formAccountSettings" action="{{'/admin/setting'}}" method="POST">
                        @csrf
                      <div class="row">
                          <div class="mb-3 col-md-6">
                            <label class="form-label">Email ID</label>
                            <div class="input-group input-group-merge">
                              <input class="form-control" name="email" type="email" value="{{$adminDetails['email'];}}" readonly/>
                            </div>
                          </div>
                          <div class="mb-3 col-md-6">
                            <label class="form-label">User Type</label>
                            <div class="input-group input-group-merge">
                              <input class="form-control" name="type" type="text" value="{{$adminDetails['type'];}}" readonly/>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="mb-3 col-md-4 form-password-toggle">
                            ...
                            <div class="input-group input-group-merge">
                              <input class="form-control" type="password"
                                name="currentPassword"   autocomplete="new-password"
                          ...
                          <div class="col-12 mt-1">
                            <button name="" type="submit" class="btn btn-primary me-2">Save changes</button>
                            <button name="" type="reset" class="btn btn-label-secondary">Cancel</button>
                          </div>
                        </div>
                      </form>
                    </div>
                    ...
                    <div class="modal-dialog modal-simple modal-enable-otp modal-dialog-centered">
                      <div class="modal-content p-3 p-md-5">
                        <div class="modal-body">
                          <button name="" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                          ...
                          <form id="enableOTPForm" class="row g-3" onsubmit="return false">
                            ...
                            <div class="col-12">
                              <button name="" type="submit" class="btn btn-primary me-sm-3 me-1">Submit</button>
                              <button
                                name="" type="reset"
                    ...
                    <div class="row">
                        ...
                        <div class="card-body">
                          <form id="formAccountSettingsApiKey" method="POST" onsubmit="return false">
                            <div class="row">
                              ...
                              <div class="col-12">
                                <button name="" type="submit" class="btn btn-primary me-2 d-grid w-100">Create Key</button>
                              </div>
                            </div>
                          </form>
                        </div>
                      ...
                      <div class="col-md-7 order-md-1 order-0">
                        <div class="text-center mt-4 mx-3 mx-md-0">
                          <img
                            src="{{ url('backend/assets/img/illustrations/sitting-girl-with-laptop-light.png')}}"
                            class="img-fluid"
                            alt="Api Key Image"
                            width="350"
