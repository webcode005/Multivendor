                ...
                <div class="col-md-12 col-lg-4 mb-4">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-8">
                        <div class="card-body">
                          <h6 class="card-title mb-1 text-nowrap">Congratulations {{Auth::guard('admin')->user()->name}}!</h6>
                      ...
                      <div class="col-4 pt-3 ps-0">
                        <img
                          src="{{ url('backend/assets/img/illustrations/prize-light.png')}}"
                          width="90"
                          height="140"
                          class="rounded-start"
                          alt="View Sales"
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="{{ url('backend/assets/img/icons/unicons/briefcase.png')}}"
                                alt="Credit Card"
                                class="rounded"
                              />
                            </div>
                          ...
                          <div class="report-list">
                            <div class="report-list-item rounded-2 mb-3">
                              <div class="d-flex align-items-start">
                                <div class="report-list-icon shadow-sm me-2">
                                  <img
                                    src="{{ url('backend/assets/svg/icons/paypal-icon.svg')}}"
                                    width="22"
                                    height="22"
                                    alt="Paypal"
                                  />
                            ...
                            <div class="report-list-item rounded-2 mb-3">
                              <div class="d-flex align-items-start">
                                <div class="report-list-icon shadow-sm me-2">
                                  <img
                                    src="{{ url('backend/assets/svg/icons/shopping-bag-icon.svg')}}"
                                    width="22"
                                    height="22"
                                    alt="Shopping Bag"
                                  />
                            ...
                            <div class="report-list-item rounded-2">
                              <div class="d-flex align-items-start">
                                <div class="report-list-icon shadow-sm me-2">
                                  <img
                                    src="{{ url('backend/assets/svg/icons/wallet-icon.svg')}}"
                                    width="22"
                                    height="22"
                                    alt="Wallet"
                                  />
                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="card-title d-flex align-items-start justify-content-between">
                            <div class="avatar flex-shrink-0">
                              <img
                                src="{{ url('backend/assets/img/icons/unicons/cc-warning.png')}}"
                                alt="Credit Card"
                                class="rounded"
                              />
                            </div>
                        ...
                        <tbody class="table-border-bottom-0">
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ url('backend/assets/img/icons/products/oneplus.png')}}"
                                  alt="Oneplus"
                                  height="32"
                                  width="32"
                                  class="me-2"
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ url('backend/assets/img/icons/products/magic-mouse.png')}}"
                                  alt="Apple"
                                  height="32"
                                  width="32"
                                  class="me-2"
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ url('backend/assets/img/icons/products/imac-pro.png')}}"
                                  alt="Apple"
                                  height="32"
                                  width="32"
                                  class="me-2"
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ url('backend/assets/img/icons/products/note10.png')}}"
                                  alt="Samsung"
                                  height="32"
                                  width="32"
                                  class="me-2"
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ url('backend/assets/img/icons/products/iphone.png')}}"
                                  alt="Apple"
                                  height="32"
                                  width="32"
                                  class="me-2"
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ url('backend/assets/img/icons/products/mi-tv.png')}}"
                                  alt="Xiaomi"
                                  height="32"
                                  width="32"
                                  class="me-2"
                          ...
                          <tr>
                            <td>
                              <div class="d-flex align-items-center">
                                <img
                                  src="{{ url('backend/assets/img/icons/products/logitech-mx.png')}}"
                                  alt="Logitech"
                                  height="32"
                                  width="32"
                                  class="me-2"
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex justify-content-between">
                        <small class="text-muted"
                          >You have done <span class="fw-bold">57.6%</span> more sales.<br />Check your new badge in
                          your profile.</small
                        >
                        <div>
