...
@section('content')
  ...
  <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Vendor /</span> Personal Details</h4>
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex align-items-start align-items-sm-center gap-4">
                        <!-- <input type="hidden" name="dbimage" value="{{$vendorDetails['vendor_personal']['photo']}}"> -->
                        <img src="{{ url('backend/assets/img/profile')}}/{{$vendorDetails['vendor_personal']['photo']}}" alt="user-avatar" class="d-block rounded"  height="100"  width="100" id="uploadedAvatar" />
                    ...
                    @if($errors->any())
                        ...
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-12">
                            ...
                            <input class="form-control" type="text" id="shop_email" name="shop_email" value="{{$vendorDetails['vendor_business']['shop_email']}}"
                              placeholder="john.doe@example.com" readonly />
                          </div>
                          ...
                          <div class="mb-3 col-md-12">
                            ...
                            <div class="input-group input-group-merge">
                              <span class="input-group-text">IN (+91)</span>
                              <input type="text" id="shop_phone" name="shop_phone" class="form-control" placeholder="202 555 0111" minlength="10" maxlength="10" value="{{$vendorDetails['vendor_business']['shop_phone']}}"/>
                            </div>
                          </div>
                          <div class="mb-3 col-md-12">
                            <label for="shop_address" class="form-label">Shop Address</label>
                            <input type="text" class="form-control" id="shop_address" name="shop_address"  value="{{$vendorDetails['vendor_business']['shop_address']}}"  placeholder="Address" />
                          </div>
                          <div class="mb-3 col-md-12">
                            <label for="shop_city" class="form-label">Shop City</label>
                            <input type="text" class="form-control" id="shop_city" name="shop_city"  value="{{$vendorDetails['vendor_business']['shop_city']}}"  placeholder="Address" />
                          </div>
                          <div class="mb-3 col-md-12">
                            <label for="shop_state" class="form-label">Shop State</label>
                            <input class="form-control" type="text" id="shop_state" name="shop_state" placeholder="California"  value="{{$vendorDetails['vendor_business']['shop_state']}}"/>
                          </div>
                          ...
                          <div class="mb-3 col-md-12">
                            ...
                            <select id="shop_country" name="shop_country" class="select2 form-select">
                              ...
                              <option value="{{$vendorDetails['vendor_business']['shop_country']}}">{{$vendorDetails['vendor_business']['shop_country']}}</option>
                              <option value="">Select</option>
                              <option value="Australia">Australia</option>
                              <option value="Bangladesh">Bangladesh</option>
                              <option value="Belarus">Belarus</option>
                          ...
                          <div class="mb-3 col-md-12">
                            ...
                            <input type="text" class="form-control"  id="business_license_number" name="business_license_number" placeholder="231465" value="{{$vendorDetails['vendor_business']['business_license_number']}}">
                          </div>

                          <div class="mb-3 col-md-12">
                            <label for="gst_number" class="form-label">GST Number</label>
                            <input type="text" class="form-control" id="gst_number" name="gst_number" placeholder="231465" maxlength="13"value="{{$vendorDetails['vendor_business']['gst_number']}}"/>
                          </div>

                          <div class="mb-3 col-md-12">
                            <label for="pan_number" class="form-label">Pan Number</label>
                            <input type="text" class="form-control" id="pan_number" name="pan_number" placeholder="231465" maxlength="10" value="{{$vendorDetails['vendor_business']['pan_number']}}" />
                          </div>
                          
                          <div class="mb-3 col-md-12">
                            <label for="shop_address_proof" class="form-label">Shop Address Proof</label>
                            <input type="text" class="form-control" id="shop_address_proof" name="shop_address_proof" placeholder="231465" maxlength="6" value="{{$vendorDetails['vendor_business']['shop_address_proof']}}">
                          </div>
                          ...
                          <label for="shop_address_proof_image" class="form-label">Shop Address Proof Image</label>
                                <div class="d-flex align-items-start align-items-sm-center gap-4">
                                    <input type="hidden" name="dbimage" value="{{$vendorDetails['vendor_business']['proof_image']}}">
                                    <img src="{{ url('backend/assets/img/proof')}}/{{$vendorDetails['vendor_business']['proof_image']}}" alt="Shop Address Proof Image" class="d-block rounded"  height="100"  width="100" id="uploadedAvatar" />
                                    <!-- <div class="button-wrapper">
                                        <label for="upload" class="btn btn-primary me-2 mb-4" tabindex="0">
                    ...
                    <form id="formAccountSettings" method="POST" action="{{url('admin/update-vendor-details/bank')}}">
                        ...
                        <div class="row">
                          <div class="mb-3 col-md-12">
                            ...
                            <input class="form-control" type="text" id="account_holder_name" name="account_holder_name" value="{{$vendorDetails['vendor_bank']['account_holder_name']}}"/>
                          </div>
                          <div class="mb-3 col-md-12">
                            <label for="Company" class="form-label">Company</label>
                            <input type="text" class="form-control" id="Company" name="company"value="{{Auth::guard('admin')->user()->company}}"  readonly />
                          ...
                          <div class="mb-3 col-md-12">
                            ...
                            <input class="form-control" type="text" name="bank_name" id="bank_name" value="{{$vendorDetails['vendor_bank']['bank_name']}}" />
                          </div>
                          <div class="mb-3 col-md-12">
                            <label for="account_number" class="form-label">Account Number</label>
                            <input class="form-control" type="text" id="account_number" name="account_number" value="{{$vendorDetails['vendor_bank']['account_number']}}"
                          ...
                          <div class="mb-3 col-md-12">
                            ...
                            <input type="text" id="bank_ifsc_code"  name="bank_ifsc_code" class="form-control" placeholder="SBIN0111" value="{{$vendorDetails['vendor_bank']['bank_ifsc_code']}}">
